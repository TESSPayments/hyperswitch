...
impl transformers::ForeignTryFrom<payments_grpc::PaymentChargeType>
...
impl transformers::ForeignTryFrom<payments_grpc::AdyenSplitType> for common_enums::AdyenSplitType {
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl transformers::ForeignTryFrom<payments_grpc::AdyenSplitItem>
    for common_types::domain::AdyenSplitItem
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl transformers::ForeignTryFrom<payments_grpc::AdyenSplitData>
    for common_types::domain::AdyenSplitData
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl transformers::ForeignTryFrom<payments_grpc::StripeSplitResponseData>
...
impl transformers::ForeignTryFrom<payments_grpc::ConnectorSplitResponseData>
    for common_types::payments::ConnectorChargeResponseData
{
    ...
    fn foreign_try_from(
        ...
        match split_data.split_response_type {
            Some(payments_grpc::connector_split_response_data::SplitResponseType::StripeSplitResponse(stripe)) => {
                Ok(Self::StripeSplitPayment(
                    common_types::payments::StripeChargeResponseData::foreign_try_from(stripe)?,
                ))
            }
            Some(payments_grpc::connector_split_response_data::SplitResponseType::AdyenSplitResponse(adyen)) => {
    ...
    for common_enums::PayoutStatus
{
    ...
    fn foreign_try_from(
        ...
        match grpc_status {
            ...
            payments_grpc::payout_enums::PayoutStatus::Initiated => Ok(Self::Initiated),
            payments_grpc::payout_enums::PayoutStatus::Expired => Ok(Self::Expired),
            ...
            payments_grpc::payout_enums::PayoutStatus::RequiresConfirmation => {
                Ok(Self::RequiresConfirmation)
            }
            payments_grpc::payout_enums::PayoutStatus::RequiresPayoutMethodData => {
                Ok(Self::RequiresPayoutMethodData)
            }
            payments_grpc::payout_enums::PayoutStatus::RequiresFulfillment => {
                Ok(Self::RequiresFulfillment)
            }
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoCreate,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceCreateRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
    ...
    fn foreign_try_from(
        ...
        let money = Some(payments_grpc::Money {
            minor_amount: amount,
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoCancel,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceVoidRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            ...
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceTransferRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoQuote,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceStageRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoRecipient,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceCreateRecipientRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoRecipientAccount,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceEnrollDisburseAccountRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
...
impl
    transformers::ForeignTryFrom<
        &RouterData<
            hyperswitch_domain_models::router_flow_types::payouts::PoSync,
            router_request_types::PayoutsData,
            PayoutsResponseData,
        >,
    > for payments_grpc::PayoutServiceGetRequest
{
    type Error = error_stack::Report<UnifiedConnectorServiceError>;
